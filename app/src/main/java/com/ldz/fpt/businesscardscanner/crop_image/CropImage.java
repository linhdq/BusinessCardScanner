...
package com.ldz.fpt.businesscardscanner.crop_image;
...
import com.ldz.fpt.businesscardscanner.activity.CropImageActivity;
...
public final class CropImage {
    ...
    /**
     * The key used to pass crop image source URI to {@link }.
     */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /**
     * The key used to pass crop image options to {@link }.
     */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /**
     * The key used to pass crop image result data back from {@link }.
     */
    ...
    /**
     * The request code used to start {@link } to be used on result to identify the this specific
     * request.
     */
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context) {
        return getPickImageChooserIntent(context, "Select image", false);
    }
    ...
    /**
     * Create {@link ActivityBuilder} instance to start {@link } to crop the given image.<br>
    ...
    /**
     * Get {@link } result data object for crop image activity started using {@link #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * Get {@link } intent to start the activity.
         */
